...
exports.TIERS = exports.PERSONAS = void 0;
exports.getAllPersonas = getAllPersonas;
exports.getPersonasByTier = getPersonasByTier;
exports.getPersona = getPersona;
exports.getEmployeeTools = getEmployeeTools;
exports.getPersonaFeaturesArray = getPersonaFeaturesArray;
// ============================================================================
// AI EMPLOYEE PERSONAS
// ============================================================================
exports.PERSONAS = {
 ...
 */
function getPersonasByTier(tier) {
    return Object.values(exports.PERSONAS).filter(p => p.tier === tier);
}
/**
 * Get a single persona by key
 */
function getPersona(key) {
    return exports.PERSONAS[key.toLowerCase()];
}
/**
...
function getEmployeeTools(employeeType) {
    const persona = exports.PERSONAS[employeeType.toLowerCase()];
    return persona?.tools || [];
}
/**
 * Get features array for SQL seeding
 */
function getPersonaFeaturesArray(personaKey) {
    const persona = exports.PERSONAS[personaKey.toLowerCase()];
    return persona?.features || [];
}
// ============================================================================
// EXPORTS
// ============================================================================
exports.default = exports.PERSONAS;
